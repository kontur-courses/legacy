...
namespace ProviderProcessing.Solved_WithCharacterizationTests
{
    public class ProcessReport
    {
        ...
        private readonly ProductValidationResult[] ProductValidationResults;
        ...
        {
            return Success == other.Success && string.Equals(Error, other.Error) && ProductValidationResults.SequenceEqual(other.ProductValidationResults);
        }
        ...
        {
            return ProductValidationResults.OrderByDescending(v => v.Severity).FirstOrDefault();
        }
    }
}